...
void speedUp( ) {
	...
	std::vector<double> At		 = { //1.0, 10.0, 25.0, 50.0, 75.0, 
									 100.0, 150.0, 250.0, 300, 400, 500, 600.0, 700, 800, 900, 1000 };
	std::vector<uint32_t> depthA = {  //18,   18,   18,   18,   18,    
									  18,    18,    17,  17,  17,  17,    16,  16,  16,  16,   16};
	double C = 15e-9;
	uint32_t i = 0;
	for (auto A : At) {
		double ac = A*C;
